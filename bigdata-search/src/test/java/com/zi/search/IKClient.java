...
public class IKClient {
	...
	public static void main(String args[]) throws IOException { 
		IKClient ikClient = new IKClient();
...
//		long one = System.currentTimeMillis();
		ikClient.queryData("index", "type","情况",0,10);
//		long two = System.currentTimeMillis();
//		System.out.println(two - one+"ms==============================================>");
//		ikClient.queryData("index", "type","知道",0,10);
//		long three = System.currentTimeMillis();
//		System.out.println(three- two+"ms==============================================>");
//		ikClient.queryData("index", "type","中国",0,10);
//		System.out.println(System.currentTimeMillis()- three+"ms==============================================>");
	}
	/**
	 * 获取链接
	 * @return
	...
	public void createData(String index, String type) {
		List<String> jsondata = IKClient.getInitJsonData();
		for (int i = 0; i < jsondata.size(); i++) {
			IndexResponse indexResp = client
					.prepareIndex()
					.setIndex(index)
					.setType(type)
...
//		list.add("{\"content\":\"什么情况\"}");
	 ...
	 * @param type
	 */
	public void queryData(String index, String type,String field,int start,int size) {
		//	重启 ES 实例
		//	英文单词必须是小写  才能检索到
//		QueryBuilder queryBuilder = QueryBuilders.termQuery("content", "百度");
		QueryBuilder queryBuilder = QueryBuilders
//				.matchQuery("content", new String[]{"知道 百度"})
//				.matchQuery("content", new String[]{"中国"})
