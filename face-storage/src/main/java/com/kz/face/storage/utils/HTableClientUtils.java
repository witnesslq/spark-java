...
public class HTableClientUtils {
  ...
  static {
    ...
    configuration.set("hbase.zookeeper.quorum", PropertiesUtil.getValue("zookeeper_connect"));
    try {
  ...
  public static void createPool() {
    ...
    if (connection == null || hBaseAdmin == null) {
      ...
      try {
        ...
        logger.error("init hbase pool failure...");
        e.printStackTrace();
      }
    }
  ...
  public static void createTable(String tableName, String[] cfs, byte[][] splitkeys)
      throws IOException {
    ...
    try {
      ...
      logger.error(
          "create table through splitkeys failure...tableName:" + tableName + "--->cfs:" + cfs);
      e.printStackTrace();
      throw e;
    }
  }
  ...
  public static void main(String[] args) {
    System.out.println(HTableClientUtils.tableExist("group_test_1000W"));
    try {
      int splitNum = 30;
